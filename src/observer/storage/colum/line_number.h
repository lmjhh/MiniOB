...
#ifndef MINIDB_LINE_NUMBER_H
#define MINIDB_LINE_NUMBER_H

#include "column.h"

class LineNumColumn : public Column {
public:
  LineNumColumn() = default;
  ...
  static void insert_from_order(void *data, int index);
private:
  uint32_t current_data_ = 0;
};

#endif //MINIDB_LINE_NUMBER_H
